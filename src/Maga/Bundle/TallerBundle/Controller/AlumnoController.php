...
use Maga\Bundle\TallerBundle\Entity\Alumno;
use Maga\Bundle\TallerBundle\Form\AlumnoType;
...
class AlumnoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MagaTallerBundle:Alumno')->findAll();
     ...
     * @Method("POST")
     * @Template("MagaTallerBundle:Alumno:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MagaTallerBundle:Alumno')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MagaTallerBundle:Alumno:edit.html.twig")
     */

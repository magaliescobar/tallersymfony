...
namespace Maga\Bundle\TallerBundle\Controller;
...
use Maga\Bundle\TallerBundle\Entity\Materia;
use Maga\Bundle\TallerBundle\Form\MateriaType;
...
class MateriaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MagaTallerBundle:Materia')->findAll();
     ...
     * @Method("POST")
     * @Template("MagaTallerBundle:Materia:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MagaTallerBundle:Materia')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MagaTallerBundle:Materia:edit.html.twig")
     */

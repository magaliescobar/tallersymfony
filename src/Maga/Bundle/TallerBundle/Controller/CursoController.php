...
use Maga\Bundle\TallerBundle\Entity\Curso;
use Maga\Bundle\TallerBundle\Form\CursoType;
...
class CursoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MagaTallerBundle:Curso')->findAll();
     ...
     * @Method("POST")
     * @Template("MagaTallerBundle:Curso:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MagaTallerBundle:Curso')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MagaTallerBundle:Curso:edit.html.twig")
     */
